...
```{r siblings_funcs, include = FALSE, cache=FALSE}
...
```{r siblings, include = FALSE, dependson=load}
siblings <-
  persons_uil %>%
  get_siblings_by_at(
...
```{r siblings_n, include = FALSE, dependson=siblings}
siblings_n <-
  siblings %>% 
...
```{r html_siblings_n, echo = FALSE, include = TRUE, dependson=siblings}
html_siblings_n <-
  siblings_n %>%
...
```{r html_siblings_lax_n, echo = FALSE, include = TRUE, dependson=-1}
html_siblings_lax_n <-
  siblings_lax_n %>%
  create_kable_filt_at(
    config = config,
...
```{r siblings_prnk, include = FALSE, dependson=siblings}
siblings_prnk <-
  siblings %>%
...
```{r html_siblings_prnk, echo = FALSE, include = TRUE, dependson=-1}
html_siblings_prnk <-
  siblings_prnk %>%
  create_kable_filt_at(
    config = config,
...
```{r persons_n_filt, include = FALSE, dependson=load}
persons_n_filt <-
  persons_uil %>%
...
```{r html_persons_n_filt, echo = FALSE, include = TRUE, dependson=-1}
html_persons_n_filt <-
  persons_n_filt %>% 
  create_kable_filt_at(
    config = config,
