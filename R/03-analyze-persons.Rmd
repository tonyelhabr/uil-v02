...
```{r html_person_n, echo = FALSE, include = TRUE}
html_persons_n <-
  persons_n %>%
...
```{r viz_persons_n_top_byconf, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
...
```{r viz_persons_stats_byconf, include = FALSE, fig.show = "asis", , fig.height = 7, fig.width = 7, eval = FALSE}
...
```{r viz_persons_stats_n_x, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
count_rename_at <-
...
```{r viz_schools_stats_n_x, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
...
```{r persons_n4, include = FALSE}
persons_n4 <-
  persons_multi %>% 
  filter(n == 4)
```

```{r html_persons_n4_state, echo = FALSE, include = FALSE}
...
```{r viz_comp_stats_byperson_byschool, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
set.seed(42)
...
```{r persons_improve_n, include = FALSE}
persons_improve <-
  persons_uil %>% 
...
```{r html_persons_improve_n, echo = FALSE, include = TRUE}
...
```{r persons_improve_btest, include = FALSE}
...
```{r html_persons_improve_btest, echo = FALSE, include = TRUE}
...
```{r viz_persons_n4, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
persons_n4_viz <-
  persons_uil %>% 
