...
```{r html_person_n_top_byconf, echo = FALSE, include = TRUE, dependson = c("load", "persons_n_top_byconf")}
...
```{r viz_persons_n_top_byconf, echo = FALSE, include = TRUE, fig.height = 7, fig.width = 7, dependson = c("load", "persons_n")}
lab_caption_persons_n_top_byconf <-
  paste0(
    config$viz_footer,
    str_wrap("\"Tier\" of individuals ranked by count of competitions is emphasized by shading.", 100)
  )
viz_persons_n_top_byconf <-
  ...
  labs(
    ...
    caption = lab_caption_persons_n_top_byconf,
    x = "Conference",
...
although it can be sensitive to the sample size of each participant. (include.echo. 
