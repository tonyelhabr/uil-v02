...
```{r viz_n_bycomplvl, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
viz_n_bycomplvl <-
  summ_n_bycomplvl %>%
...
```{r viz_n_bycomp, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
viz_n_bycomp <-
  summ_n_bycomp %>%
...
```{r viz_n_bycompcomplvl, echo = FALSE, include = TRUE, fig.show = "asis"}
viz_n_bycompcomplvl <-
  summ_n_bycompcomplvl %>%
...
```{r viz_n_bycompcomplvlconf, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
...
```{r viz_persons_stats_bycomp, echo = FALSE, include = TRUE, fig.show = "asis", fig.width = 7, fig.height = 10}
...
```{r persons_stats_bycompx, include = FALSE}
...
```{r viz_persons_stats_bycompx, include = FALSE, fig.show = "hide"}
...
```{r viz_persons_stats_bycomp_grid, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 10, fig.width = 7}
...
```{r viz_persons_stats_bycompcomplvl_diffs, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
...
```{r viz_persons_stats_bycompyear_diffs, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
...
```{r html_persons_stats_bycompyear_terms, include = FALSE}
persons_stats_bycompyear_terms %>%
  # filter(term == "year") %>%
