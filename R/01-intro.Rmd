...
(The geo-spatial data for the
visual can be downloaded from
https://nces.ed.gov/opengis/rest/services/K12_School_Locations/EDGE_GEOCODE_PUBLICSCH_1516/MapServer.
"Fuzzy-joining" with the school names from the UIL data scraped from https://www.hpscience.net/ was
used to identify the districts and regions.)
...
+ I scaped data from https://www.hpscience.net/ for all years through the current year since 2008.
The data is not listed in an extremely user-friendly format (in my opinion). Consequently, the "cleaned"
data is imperfect in some ways. (For example
