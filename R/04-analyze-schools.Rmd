...
```{r viz_map_schools_stats_tier3_byyear, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
...
```{r viz_map_schools_stats_tier3, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
...
```{r schools_stats_bycomp_terms, include = FALSE}
...
```{r viz_schools_stats_bycomp_pv, echo = FALSE, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
...
```{r viz_schools_n_defeat_pct, include = TRUE, fig.show = "asis", fig.height = 7, fig.width = 7}
schools_n_defeat <-
  schools_uil %>% 
